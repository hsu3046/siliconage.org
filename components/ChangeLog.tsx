                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-slate-500 text-sm">2025-12-08</span>
                        </div>

                        <div className="space-y-6">
                            <div>
                                <h3 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
                                    <span className="text-amber-400">⚡</span> Major Updates
                                </h3>
                                <ul className="space-y-2 text-slate-300 text-sm">
                                    <li className="flex items-start gap-2">
                                        <span className="text-amber-400 mt-1">•</span>
                                        <span><strong className="text-white">Completely New History View UI:</strong> Redesigned for a clearer historical narrative.</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-amber-400 mt-1">•</span>
                                        <span><strong className="text-white">Completely New Links View UI:</strong> A fresh interface to explore complex relationships.</span>
                                    </li>
                                    <li className="flex items-start gap-2">
                                        <span className="text-amber-400 mt-1">•</span>
                                        <span><strong className="text-white">Data Overhaul:</strong> Comprehensive review and update of all Companies, Technologies, Persons, and Episodes.</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-slate-300 text-sm">
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span><strong className="text-white">Search Engine:</strong> Significantly enhanced search functionality across all views.</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-slate-300 text-sm">
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span><strong className="text-white">Bug Fixes:</strong> Miscellaneous bug fixes and stability improvements.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
